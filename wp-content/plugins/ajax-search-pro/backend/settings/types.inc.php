...
if (!function_exists("admin_stylesV04")) {
    function admin_stylesV04() {
        ...
        wp_register_style('wpdreams-style', ASP_URL . 'backend/settings/assets/style.css', array('wpdreams-tabs'), $media_query);
        ...
        wp_enqueue_style('wpdreams_animations', ASP_URL . 'css/animations.css', array(), $media_query);
