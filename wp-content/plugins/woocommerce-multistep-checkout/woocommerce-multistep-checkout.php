 ...
 */
add_filter('woocommerce_locate_template', 'wcmultichecout_woocommerce_locate_template', 300, 3);
 ...
 */
function wmc_registration_redirect()
{
    global $woocommerce;
...
add_action('woocommerce_registration_redirect', 'wmc_registration_redirect', 2);
