...
class WC_PagSeguro_Gateway extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_description = __( 'Aceita pagamentos pelos métodos aceitos no PagSeguro.', 'woocommerce-pagseguro' );
		$this->order_button_text  = __( 'Seguir para o pagamento', 'woocommerce-pagseguro' );
