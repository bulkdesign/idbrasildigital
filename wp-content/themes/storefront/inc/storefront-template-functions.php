	...
	function storefront_primary_navigation() {
		...
		<button class="menu-toggle" aria-controls="site-navigation" aria-expanded="false"><span><?php echo esc_attr( apply_filters( 'storefront_menu_toggle_text', __( 'Menu', 'storefront' ) ) ); ?></span></button>
			<ul id="nav-mobile" class="left hide-on-med-and-down">
				<!-- OPCAO 1 -->
				<li>
                	<a class='dropdown-button' data-beloworigin="true" href='#' data-activates='dropdown1' class="black-text">Acessórios</a>
                </li>
				<!-- Dropdown Structure -->
				<ul id='dropdown1' class='dropdown-content'>
					<div class="row">
						<div class="col s12 borda-baixo">
							<h5>Anéis</h5>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/anel/aparadores/">Aparadores</a></li>
							</div>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/anel/solitarios/">Solitários</a></li>
							</div>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/anel/cravejados/">Cravejados</a></li>
							</div>
						</div>
						<div class="col s12 paddingtop borda-baixo">
							<h5>Brincos</h5>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/brincos/argolas/">Argolas</a></li>
							</div>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/brincos/earcuff/">Ear Cuff</a></li>
							</div>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/brincos/dourados/">Dourados</a></li>
							</div>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/brincos/segundofuro/">Segundo Furo</a></li>
							</div>							
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/brincos/cravejados-brincos/">Cravejados</a></li>
							</div>
						</div>
						<div class="col s12 paddingtop borda-baixo">
							<h5>Colares</h5>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/colares/chokers/">Chokers</a></li>
							</div>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/colares/longos_colares/">Longos</a></li>
							</div>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/colares/cravejados-colares/">Cravejados</a></li>
							</div>
						</div>
						<div class="col s12 paddingtop borda-baixo">
							<h5>Pulseiras</h5>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/pulseiras/shambalas/">Shambalas</a></li>
							</div>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/pulseiras/braceletes/">Braceletes</a></li>
							</div>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/pulseiras/cravejados-pulseiras/">Cravejados</a></li>
							</div>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/pulseiras/wishes/">Wishes</a></li>
							</div>
						</div>
						<div class="col s12 paddingtop borda-baixo">
							<h5>Hairpieces</h5>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/hairpieces/bicodepato/">Bico de Pato</a></li>
							</div>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/hairpieces/elastico/">Elástico</a></li>
							</div>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/hairpieces/piranhas/">Piranha</a></li>
							</div>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/hairpieces/presilha/">Presilha</a></li>
							</div>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/hairpieces/tiara/">Tiara</a></li>
							</div>							
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/hairpieces/tictac/">Tic Tac</a></li>
							</div>							
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/hairpieces/grampo/">Grampo</a></li>
							</div>
						</div>
						<div class="col s12 paddingtop">
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/tornozeleiras"><h5>Tornozeleiras</h5></a></li>
							</div>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/necessaire"><h5>Nécessaire</h5></a></li>
							</div>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios/outros"><h5>Outros</h5></a></li>
							</div>
							<div class="col l3 m4 s12">
								<li><a href="/categorias/acessorios"><h5>Ver Todos</h5></a></li>
							</div>
						</div>				
					</div>
				</ul>
				<!-- OPCAO 2 -->
				<li>
                	<a class='dropdown-button' data-beloworigin="true" href='#' data-activates='dropdown2' class="black-text">Verão</a>
                </li>
				<!-- Dropdown Structure -->
						...
						<div class="col s12 paddingtop">
							<div class="col l2 m4 s12">
								<li class="paddingtop borda-baixo">
									<a href="/categorias/verao/bolsas">
										<h5>Bolsas</h5>
									</a>
								</li>
							</div>
							...
							<div class="col l2 m4 s12">
								<li class="paddingtop borda-baixo">
									<a href="/categorias/verao/chapeus">
										<h5>Chapéus</h5>
									</a>
								</li>
							</div>
							...
							<div class="col l2 m4 s12">
								<li class="paddingtop borda-baixo">
									<a href="/categorias/verao/necessaires">
										<h5>Nécessaires</h5>
									</a>
								</li>
							</div>
							<div class="col l2 m4 s12">
								<li class="paddingtop borda-baixo">
									<a href="/categorias/verao/outros">
										<h5>Outros</h5>
									</a>
								</li>
							</div>
				...
				<!-- OPCAO 3 -->
				<li>
                	<a class='dropdown-button' data-beloworigin="true" href='#' data-activates='dropdown3' class="black-text">Kids</a>
                </li>
				<!-- Dropdown Structure -->
				...
				<!-- OPCAO 4 -->
				<li><a href='/personalizados' class="black-text">Personalizados</a></li>
				<!-- OPCAO 5 -->
				<li>
                	<a class='dropdown-button' data-beloworigin="true" href='#' data-activates='dropdown4' class="black-text">Presentes (Kits)</a>
                </li>
				<!-- Dropdown Structure -->
