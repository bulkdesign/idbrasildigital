	...
	function storefront_primary_navigation() {
		...
		<button class="menu-toggle" aria-controls="site-navigation" aria-expanded="false"><span><?php echo esc_attr( apply_filters( 'storefront_menu_toggle_text', __( 'Menu', 'storefront' ) ) ); ?></span></button>
			...
			<ul id="nav-mobile" class="right hide-on-small-only">
              	<li><a href="http://bulkdesign.com.br/aniastore2/" class="black-text">Home</a></li>
                ...
                <li><a href="minha-conta" class="black-text">Minha Conta</a></li>
                <li><a href="http://facebook.com/storeania" class="black-text" target="_blank"><img src="<?php bloginfo('template_url');?>/images/Facebook.png" class="social-nav"></a></li>
                <li><a href="http://www.imgins.org/store_ania" class="black-text" target="_blank"><img src="<?php bloginfo('template_url');?>/images/Instagram.png" class="social-nav"></a></li>
                <li><a href="Contato" class="black-text" style=""><img src="<?php bloginfo('template_url');?>/images/Whatsapp.png" class="social-nav"></a></li>
            </ul>
