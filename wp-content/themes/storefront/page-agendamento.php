...
<div id="post-<?php the_ID(); ?>">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col s12">
        <p>Selecione Instalação Técnica Secundaria (ITS) onde você deseja realizar a validação presencial:</p>
      </div>
    </div>
  </div>
  ...
  <div class="hide-on-med-and-down">
    <a href="/agendamento-centro/">
      <div class="hoverable agendamento-centro">
        <h1 class="white-text bold">Autoridade de Registro (AR) - Centro
    ...
    <a href="/agendamento-boqueirao/">
      <div class="hoverable agendamento-boqueirao">
        <h1 class="white-text bold">ITS - Boqueirão
    ...
    <a href="/agendamento-sitio-cercado/">
      <div class="hoverable agendamento-sitiocercado">
        <h1 class="white-text bold">ITS - Sítio Cercado
